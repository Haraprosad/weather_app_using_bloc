...
///##################################################################
  ...
  required double latitude,
    ...
    if(!weatherJson.containsKey('current_weather')) throw WeatherNotFoundFailure();

    final currentWeather = weatherJson['current_weather'] as Map<String,dynamic>;
